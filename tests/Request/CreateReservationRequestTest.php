...
class CreateReservationRequestTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testJsonSerialize()
    {
        ...
        $reservation = new \Rentlio\Api\Request\Data\Reservation(1, '1530537657', '1530537659');
        $request->setReservation($reservation);

        $requestBody = json_encode($request);
        $this->assertJson($requestBody);
        $this->assertEquals('{"unitTypeId":1,"dateFrom":"1530537657","dateTo":"1530537659"}', $requestBody);
