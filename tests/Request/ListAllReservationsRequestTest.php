...
class ListAllReservationsRequestTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testRequestSortChangedUri()
    {
        ...
        $request->setStatus(1);
        $request->setUnitsId('2345');
        $request->setPropertiesId('1212');
        $request->setBookedAtFrom('2017-12-13');
        $request->setBookedAtTo('2017-12-23');
        $request->setCancelAtFrom('2017-12-24');
        $request->setCancelAtTo('2017-12-26');
        $request->setCreatedAtFrom('2017-11-24');
        $request->setCreatedAtTo('2017-11-30');
        $request->setModifiedAtFrom('2017-12-29');
        $request->setModifiedAtTo('2017-12-30');
